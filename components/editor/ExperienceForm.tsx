...
import { Briefcase, Plus, Minus, Trash2, ChevronUp, ChevronDown, Calendar, GripVertical, Type, Eye, EyeOff } from 'lucide-react';
    ...
    >
      <div className="space-y-4">
        {data.experience.map((exp, idx) => (
          ...
          >
             <div className={`absolute top-3 right-3 flex gap-0.5 items-center transition-opacity bg-white dark:bg-zinc-800 p-1 rounded-lg border border-gray-100 dark:border-zinc-700 shadow-sm z-10 ${exp.hidden ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}>
